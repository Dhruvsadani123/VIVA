...
def sendEmail(to, content):
    ...
    server.login('dhruv.sadani@gmail.com', 'dhruv2724')
    server.sendmail('dhruv.sadani@gmail.com', to, content)
    server.close()
    ...
    def clicked(self):
        ...
        while True:
            ...
            if 'wikipedia' in query:
                ...
                speak("I have been created by Dhruv & Pranay Sadani.")
                ...
                speak("Thanks to Pranay & Dhruv Sadani. further It's a secret")
